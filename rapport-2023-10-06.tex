...
\label{sec:org91df4df}
\subsection{Introduction}
\label{sec:org2369a76}
Pour se connecter,
\begin{verbatim}
...
Dans leur résumé, \Citet{suzuki2016understanding}  expliquent que la dérive de Stokes est une contribution lagrangienne à notre écoulement, de sorte qu'on peut décrire ce courant lagrangien par
\begin{equation}
   \uu_L = \uu + \uu_S,
\end{equation}
