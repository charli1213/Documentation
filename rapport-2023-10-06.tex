...
\label{sec:orgcb26c1c}
\subsection{Introduction}
\label{sec:orgc838cea}
Pour se connecter,
\begin{verbatim}
  ssh -Y celiz2@beluga.computecanada.ca
\end{verbatim}
Le mot de passe est laissé à la discrétion du lecteur de ce rapport.
En résumé, nous travaillons sur la grappe de calcul de l'ETS, soit Beluga en l'honneur de la baleine qui est en train de crever dans le Saint-Laurent.\bigskip

\subsection{Modules}
\label{sec:org6f30fd5}
...
\label{sec:org2be52ac}



\section{{\bfseries\sffamily TODO} Nouveau schéma pour l'introduction de la dérive de Stokes dans les équations du mouvement -- \textit{<2023-10-06 ven.>}}
\label{sec:org6aecc10}
