...
\label{sec:org484b2e7}
\subsection{Mise en contexte}
\label{sec:org1c2f64a}
...
Le test lancé pendant la fin de semaine devrait nous encourager (Voir figure \ref{fig:orga229b05}).

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{figures/tests/test_SW_2023-03-18.png}
\caption{\label{fig:orga229b05}Résultat du test de qualité du modèle. En ordre, diagramme de Hovmoller de la divergence, du rotationnel et du courant dans la première couche.}
\end{figure}
\end{document}