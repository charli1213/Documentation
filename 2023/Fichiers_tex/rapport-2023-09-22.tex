...
\caption{\label{fig:orgc27df70}Output du vent sorti d'une rapide run de Wavewatch. Les axes sont bien ordonnés donc les input sont réglementaires.}
\end{wrapfigure}
\subsection{Re-Construire la grille, la mapsta et les forçages -- \textit{<2023-09-19 Tue>}}
\label{sec:org997ed8f}
\label{orgb34209f}
