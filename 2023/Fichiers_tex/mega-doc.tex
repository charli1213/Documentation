...
\end{tikzpicture}
\end{center}
\caption{\label{org76e0591}Illustration conceptuelle d'un modèle « shallow water » à n\textsubscript{z} = 4 couches. La densité volumique de chaque couche est grossièrement illustrée à l'aide du contrate des couleurs.}
\end{wrapfigure}
...
\end{tikzpicture}
\caption{\label{org887efe8}Représentation de la grille numérique utilisée pour le modèle en eau peu profonde (type \href{https://en.wikipedia.org/wiki/Arakawa\_grids}{Arakawa-C} )}
\end{wrapfigure}

\subsection{Conditions frontière sur les courants (No normal flow)}
\label{sec:org50f004f}
...
\end{tikzpicture}
\end{center}
\caption{\label{org59dd99b}Illustration conceptuelle de la rampe pour éviter le \emph{spin up} du modèle de vagues.}
\end{figure}
