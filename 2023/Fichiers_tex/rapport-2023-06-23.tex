...
Pour en avoir un avant goût, la figure \ref{fig:org21c378e} illustre l'état de la situation.
...
\caption{\label{fig:org21c378e}Diagrame de Hovmoller entre 0 et 950 jours pour le modèle shallow water résolu par MUDPACK. Du haut vers le bas, la vorticité, la divergence, la correction à la fonction de courant barotrope et la norme du courant. Le tout pour la première couche.}
\end{figure}
...
\caption{\label{fig:org0ee779c}Divergence du courant barotrope  \(\qty(\div{\uu_{BT}} = \qty(1/H_{tot}) \div{\sum_i h_i \uu_i})\) à divers moments pour le modèle solvé par FFTW (Le temps est donnée en jours).}
\end{figure}
...
Par exemple, comme illustré à la figure \ref{fig:org85b4a28}, les dérivées sont pratiquement identiques, mais de petits écarts se sont creusée quand on les additionne pour obtenir la divergence. 

\begin{figure}[!htpb]
\centering
\includegraphics[width=.9\linewidth]{figures/debuggage/2023_06_27_comp_divBT.png}
\caption{\label{fig:org85b4a28}Dérivées horizontales et verticales du courant barotrope et leur addition (la divergence), à droite.}
\end{figure}
...
\caption{\label{fig:org58bb80d}Test de MUDPACK où le dernier point est inclu comme un point périodique, de sorte que phi(1)=phi(nx).}
\end{figure}
...
Comme, le paramètre \(dx\) entre dans la définition de la solution réelle, on joue un tour à \emph{MUDPACK} pour inclure ou non la frontière, comme illustré dans la figure \ref{org40573a3}. \bigskip
...
Malheureusement, le résultat sur les diagrammes de Hovmoler était le même, comme on peut le voir à la figure \ref{fig:org878235f}.


\begin{figure}[!htpb]
\centering
\includegraphics[width=.9\linewidth]{figures/tests/2023-06-28_hovmoller1_nx640_t=750days.png}
\caption{\label{fig:org878235f}Diagramme de Hovmoller pour la première couche avec un nx de 640 points.}
\end{figure}
\end{document}
