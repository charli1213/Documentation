...
\label{sec:org8d3f290}

Comme ça induisait de drôles d'erreurs (voir figure \ref{fig:org310e12a}), j'ai décidé de revisiter le problème analytiquement.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{figures/tests/2023-05-23_hovmoller1.png}
\caption{\label{fig:org310e12a}Application de la correction à la solution plutôt que la solution elle-même dans le solveur elliptique de MUDPACK. Les résultats ne sont pas très positifs.}
\end{figure}

\subsection{Utiliser le dernier champ comme tentative initiale}
\label{sec:org4f28c66}
