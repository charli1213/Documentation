...
\begin{table}[htbp]
\caption{\label{tab:org3b16ce0}Valeur des différents paramètres de l'expérience de \notecite{chen_2021}, mais à 3 couches.}
\centering
\begin{tabular}{lll}
\hline
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgfcd4a9f}Tableau regroupant les paramètres de notre cas trivial.}
\centering
\begin{tabular}{lll}
\hline
\hline
...
\section{Annexe}
\label{sec:org16a3388}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{figures/tests/2023-04-08_test1.png}
\caption{\label{fig:org1cfb6ae}Résultats du test à trois couches (Première couches)}
\end{figure}
