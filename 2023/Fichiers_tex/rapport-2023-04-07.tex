...
\begin{table}[htbp]
\caption{\label{tab:orgb788b2c}Valeur des différents paramètres de l'expérience de \notecite{chen_2021}, mais à 3 couches.}
\centering
\begin{tabular}{lll}
\hline
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org41fdd96}Tableau regroupant les paramètres de notre cas trivial.}
\centering
\begin{tabular}{lll}
\hline
\hline
...
\hline
Épaisseur 1ère couche & H\textsubscript{1} & H\textsubscript{tot}/3 = H\\
Épaisseur 2ème couche & H\textsubscript{2} & H\textsubscript{tot}/3 = H\\
Épaisseur 3ème couche & H\textsubscript{3} & H\textsubscript{tot}/3 = H\\
Densité première couche & \(\rho\)\textsubscript{1} & \(\rho\)\textsubscript{1}\\
Densité secondec couche & \(\rho\)\textsubscript{2} & \(\rho\)\textsubscript{1} + \(\Delta\) \(\rho\)\\
Densité troisième couche & \(\rho\)\textsubscript{3} & \(\rho\)\textsubscript{1} + 2 \(\Delta\) \(\rho\)\\
\hline
\hline
\end{tabular}
\end{table}
...
\section{Annexe}
\label{sec:org8e736f0}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{figures/tests/2023-04-08_test1.png}
\caption{\label{fig:org0cc1d60}Résultats du test à trois couches (Première couches)}
\end{figure}
