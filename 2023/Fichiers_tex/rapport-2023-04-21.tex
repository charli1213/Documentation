...
\label{sec:org3c788e2}
\subsection{Mise en contexte}
\label{sec:org29ef407}
...
\end{tikzpicture}
\caption{\label{orgc70a8d3}Représentation de la grille numérique utilisée pour le modèle en eau peu profonde (type \href{https://en.wikipedia.org/wiki/Arakawa\_grids}{Arakawa-C} )}
\end{wrapfigure}
...
\end{tikzpicture}
\caption{\label{org87e6d05}Condition frontière mixte autour d'une région \(\Omega\) borné par la courbe \(C = C_1\cup C_2\).}
\end{wrapfigure}
