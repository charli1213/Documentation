...
\end{tikzpicture}
\end{center}
\caption{\label{org630dea2}Illustration d'un modèle \textit{shallow water} à quatre couches (\(n_k = 4\)).}
\end{wrapfigure}
