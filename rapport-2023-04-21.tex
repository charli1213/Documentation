...
\end{tikzpicture}
\caption{\label{org4198817}Condition frontière mixte autour d'une région \(\Omega\) borné par la courbe \(C = C_1\cup C_2\).}
\end{wrapfigure}
