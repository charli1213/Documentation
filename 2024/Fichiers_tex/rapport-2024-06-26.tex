...
\end{tikzpicture}
\end{center}
\caption{\label{org33697e5}Illustrations des différentes contraintes pouvant s'appliquer sur un élément infinitésimal en deux dimensions.}
\end{figure}
