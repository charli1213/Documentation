...
Ceci aura tendance à advecter la parcelle vers l'ouest, comme décrit dans l'image \ref{fig:orgfa3a0e9}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{figures/vallis/vallis_rossby_simplification.png}
\caption{\label{fig:orgfa3a0e9}Figure tirée du Vallis décrivant le comportement des parcelles de fluide à l'équateur.}
\end{figure}

\subsection{Description du système QG à \textbf{deux niveaux}}
\label{sec:org0092f17}
...
La \textbf{flottabilité} peut être décrite comme une dérivée verticale de la fonction de courant entre les deux niveaux (Voir figure \ref{org85ff3d6}).
...
%
\end{tikzpicture}
\caption{\label{org85ff3d6}Schéma conceptuel du modèle QG à deux \textbf{niveaux}. Les fonctions de courant et les vorticité potentielles}
\end{wrapfigure}
...
\caption{\label{fig:org30d51f9}Diagrames de Hovmoler pour les trois couches, période de 10 ans.}
\end{figure}
\begin{figure}[htbp]
\centering
