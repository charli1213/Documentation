...
\begin{table}[htbp]
\caption{\label{tab:org91fa161}Valeur des différents paramètres de l'expérience de \citealp{chen_2021}, mais à 3 couches.}
\centering
\begin{tabular}{lll}
\hline
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orge8106ed}Tableau regroupant les paramètres de notre cas trivial.}
\centering
\begin{tabular}{lll}
\hline
\hline
...
\section{Annexe}
\label{sec:orgc801267}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{figures/tests/2023-04-08_test1.png}
\caption{\label{fig:orgf653c16}Résultats du test à trois couches (Première couches)}
\end{figure}
