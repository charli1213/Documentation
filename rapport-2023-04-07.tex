...
\begin{table}[htbp]
\caption{\label{tab:org4cc2bae}Valeur des différents paramètres de l'expérience de \cite{chen_2021}, mais à 3 couches.}
\centering
\begin{tabular}{lll}
\hline
\hline
...
\begin{table}[htbp]
\caption{\label{tab:orgfe6b583}Tableau regroupant les paramètres de notre cas trivial.}
\centering
\begin{tabular}{lll}
\hline
\hline
