...
Pour l'exprimer, voir l'illustration suivante (figure \ref{org2540056}). \bigskip
...
\end{tikzpicture}
\end{center}
\caption{\label{org2540056}Illustration de l'erreur engendrée par le sous-échantillonnage des données réelles. Le résultat donne des lignes diagonales croissantes qui apparaissent un peu partout sur le domaine.}
\end{figure}
